  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch('/api/contacto', {
        ...
        body: JSON.stringify({ ...Object.fromEntries(data.entries()), origen: 'main' }),
      })
      ...
      <div className="max-w-[640px] mx-auto">
        ...
        {status === 'sent' ? (
          <div
            role="status"
            aria-live="polite"
            className="border-2 border-roble bg-white p-8 text-center"
          ...
          <form onSubmit={handleSubmit} className="rv space-y-4">
            ...
            <div>
              ...
              <div className="w-full flex border-2 border-roble bg-white focus-within:border-terra">
                ...
                <input
                  ...
                  className="flex-1 min-w-0 px-4 py-[.6rem] text-[.9rem] text-roble outline-none bg-white"
                />
              </div>
            </div>
